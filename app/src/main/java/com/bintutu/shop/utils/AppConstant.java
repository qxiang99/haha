...
public class AppConstant {
    ...
    public static String Formal_URL = "https://backend.bintutu.com/";//正式环境
    public static String BASE_URLS = Toogle ? Formal_URL : TEST_URL;


    //TODO  WEB   请在“Formal_WEB_URL=”填写正式服务器地址   并把“Toogle”修改为 true
    public static String TEST_WEB_URL = "http://ipadscan_test.bintutu.com/shop_3dscanner_learning/frontend/";//测试环境
    public static String Formal_WEB_URL = "https://newipadscan.bintutu.com/";//正式环境
    ...
    public static String TEST_IMAGE_URL = "http://resources_test.bintutu.com/";//测试环境
    public static String Formal_IMAGE_URL = "https://resources.bintutu.com/";//正式环境
    public static String BASE_IMAGEURLS = Toogle ? Formal_IMAGE_URL : TEST_IMAGE_URL;


    public static final String IMAGE_SPLIT = BASE_IMAGEURLS+"merchandise_img/homepage_img";
    ...
    //web首页
    public static final String WEBVIEW_HOME = BASE_WEB_URLS+"sort.html";
    //exhibition room
    public static final String WEBVIEW_EXHIBITIONROOM = BASE_WEB_URLS+"shopinformation.html";
    //web选鞋页
    public static final String WEBVIEW_SORT(String customer_id,String customer_phone){
        return BASE_WEB_URLS+"sort.html?customer_id="+customer_id+"&customer_phone="+customer_phone;
    };
    //web选鞋页
